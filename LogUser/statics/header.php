    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn " data-bs-target="#signUpModal" data-bs-toggle="modal" data-bs-dismiss="modal">new
                    User, please <span class='text-primary'>Register here </span></button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="signUpModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="signUpForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="userEmail" value="kites@134.coder"
            ...
            <div class="modal-footer">
                <button class="btn" data-bs-target="#loginModal" data-bs-toggle="modal" data-bs-dismiss="modal">already
                    register, <span class="text-primary">login here</span></button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 d-flex">
                ...
                if (isset($_SESSION['user_id'])) {
                    ...
                    <li class="nav-item">
                        <button class="nav-link btn-light border-0" href="#" tabindex="-1" aria-disabled="true"
